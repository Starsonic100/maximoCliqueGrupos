...
def inicP(nom,n):
	for i in range(int(n)):
		k=0
		actividad=0
		nombre=input("Inserte nombre:") #Insercion de los nombres de personas
		nom[i]=str(nombre)
...
def archivos(arch):
	file=""
	archivo=input("Inserte nombre de archivo con datos de grafo:\n")
